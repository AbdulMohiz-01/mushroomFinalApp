            ...
            >
                ...
                <View style={styles.legendsWrapper}>
                    <View style={styles.legendItem}>
                        ...
                        <Text style={styles.legend}>Conditionaly Edib.: </Text>
                    ...
                    <View style={styles.legendItem}>
                        ...
                        <Text style={styles.legend}>Deadly:</Text>
                    ...
                    <View style={styles.legendItem}>
                        ...
                        <Text style={styles.legend}>Edible: </Text>
                    ...
                    <View style={styles.legendItem}>
                        ...
                        <Text style={styles.legend}>Poisness: </Text>
